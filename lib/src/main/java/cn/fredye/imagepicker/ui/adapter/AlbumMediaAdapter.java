...
public class AlbumMediaAdapter extends
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView) {
        super(null);
        imagePickerConfiguration = ImagePickerConfiguration.getInstance();
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            mediaViewHolder.mMediaGrid.preBindMedia(new GridItemView.PreBindInfo(
                    getImageResize(mediaViewHolder.mMediaGrid.getContext()),
                    mPlaceholder,
                    imagePickerConfiguration.countable,
                    holder
            ));
    ...
    private void setCheckStatus(Item item, GridItemView mediaGrid) {
        if (imagePickerConfiguration.countable) {
    ...
    private int getImageResize(Context context) {
        if (mImageResize == 0) {
            ...
            //TODO why ?
            mImageResize = (int) (mImageResize * imagePickerConfiguration.thumbnailScale);
        }
        return mImageResize;
    }
    ...
    private static class MediaViewHolder extends RecyclerView.ViewHolder {
        ...
        private GridItemView mMediaGrid;

        MediaViewHolder(View itemView) {
            super(itemView);
            mMediaGrid = (GridItemView) itemView;
        }
    }
