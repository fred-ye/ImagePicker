...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.checkCircle_borderColor,
                getContext().getTheme());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCountable) {
            ...
            if (mChecked) {
                ...
                initUnCheckedBackgroundPaint();
                paint = mUnCheckedBackgroundPaint;
                this.setAlpha(0.8f);
            }
            canvas.drawCircle((float) SIZE * mDensity / 2, (float) SIZE * mDensity / 2,
                    BG_RADIUS * mDensity, paint);
            mCheckDrawable.setBounds(getCheckRect());
            mCheckDrawable.draw(canvas);
        }
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.checkCircle_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
    ...
    private void initUnCheckedBackgroundPaint() {
        if (mUnCheckedBackgroundPaint == null) {
            ...
            mUnCheckedBackgroundPaint.setAlpha(30);
